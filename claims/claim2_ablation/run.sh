#!/usr/bin/env sh
# claim2_ablation -- see claim.txt for what this shows, expected/ for reference values.
#
...
exec python "$ROOT/artifact/scripts/claim_runner.py" --claim claim2_ablation "$@"
