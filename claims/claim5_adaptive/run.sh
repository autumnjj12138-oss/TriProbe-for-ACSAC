#!/usr/bin/env sh
# claim5_adaptive -- see claim.txt for what this shows, expected/ for reference values.
#
...
exec python "$ROOT/artifact/scripts/claim_runner.py" --claim claim5_adaptive "$@"
