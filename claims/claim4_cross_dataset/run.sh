#!/usr/bin/env sh
# claim4_cross_dataset -- see claim.txt for what this shows, expected/ for reference values.
#
...
exec python "$ROOT/artifact/scripts/claim_runner.py" --claim claim4_cross_dataset "$@"
