#!/usr/bin/env sh
# claim3_density_cliff -- see claim.txt for what this shows, expected/ for reference values.
#
...
exec python "$ROOT/artifact/scripts/claim_runner.py" --claim claim3_density_cliff "$@"
