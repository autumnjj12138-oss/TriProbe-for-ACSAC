#!/usr/bin/env sh
# claim1_main_defense -- see claim.txt for what this shows, expected/ for reference values.
#
...
exec python "$ROOT/artifact/scripts/claim_runner.py" --claim claim1_main_defense "$@"
